...
const MODULOS: Modulo[] = [
  ...
  },
  {
    ...
    colorBg: 'bg-cyan-500/10',
    colorBorder: 'border-cyan-500/30',
    descripcion: 'Asistente de Inteligencia Artificial integrado al sistema. Ayuda con diagnósticos diferenciales, resúmenes de HC, búsqueda de medicamentos y dictado por voz.',
    roles: ['Médico', 'Administrador'],
    pasos: [
      { numero: 1, titulo: 'Abrir SARAI', descripcion: 'Haz clic en el ícono ECG/SARAI en la esquina inferior derecha de la pantalla. Se abre el panel flotante del asistente.', tipo: 'normal' },
      { numero: 2, titulo: 'Hacer una consulta', descripcion: 'Escribe tu consulta en el campo de texto. Ejemplos: "¿Cuál es la dosis de tramadol en adultos?", "Resume los síntomas del paciente" o "Diagnóstico diferencial para dolor epigástrico".', tipo: 'normal' },
      { numero: 3, titulo: 'Dictado por voz', descripcion: 'Haz clic en el ícono de micrófono. Habla claramente y el servicio Whisper transcribe tu mensaje. Luego SARAI procesa el texto con GPT-4.', tipo: 'tip' },
      { numero: 4, titulo: 'Contexto de paciente', descripcion: 'Si tienes una HC abierta, SARAI tiene acceso al contexto del paciente actual y puede hacer referencias específicas a sus datos.', tipo: 'normal' },
    ],
    tips: [
      'SARAI requiere conexión a OpenAI API — verifica la clave en las variables de entorno.',
      'El dictado por voz requiere el servicio Whisper activo en el puerto 8000.',
      'Las respuestas de SARAI son orientativas — siempre valida con criterio clínico.',
    ],
  },
];
