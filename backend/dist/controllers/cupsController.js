...
// PROCEDIMIENTOS CUPS
// ============================================
export async function getAllProcedimientos(req, res) {
    try {
...
export async function getProcedimientoByCUPS(req, res) {
    try {
...
export async function createProcedimiento(req, res) {
    try {
        const { codigoCUPS, nombre, descripcion, tipoCategoria, riesgoNivel, diasSeguimiento, datosAdicionales, } = req.body;
...
export async function updateProcedimiento(req, res) {
    try {
        const { cups } = req.params;
...
export async function deleteProcedimiento(req, res) {
    try {
        const { cups } = req.params;
...
// PLANTILLAS POR CUPS
// ============================================
export async function getPlantillasPorCUPS(req, res) {
    try {
...
export async function createPlantilla(req, res) {
    try {
        const { codigoCUPS, nombre, tipo, descripcion, seccionesJSON, requiereSignatura, requiereFoto, requiereMapaCorporal, ordenVisualizacion, } = req.body;
...
// CHECKLISTS
// ============================================
export async function getChecklistPorCUPS(req, res) {
    try {
...
// CONSENTIMIENTOS
// ============================================
export async function getConsentimientoPorCUPS(req, res) {
    try {
        const { cups } = req.params;
...
export async function createConsentimiento(req, res) {
    try {
        const { codigoCUPS, titulo, seccionesJSON, riesgosJSON, recomendacionesJSON, } = req.body;
