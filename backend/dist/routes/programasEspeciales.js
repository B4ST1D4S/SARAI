...
router.post('/renal/maquinas', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.postMaquina);
router.patch('/renal/maquinas/:id', authorizeRole('SUPER_ADMIN', 'MEDICO'), ctrl.patchMaquina);
...
router.post('/renal/inscripciones', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.postInscripcion);
...
router.patch('/renal/inscripciones/:id', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.patchInscripcion);
...
router.patch('/renal/inscripciones/:inscripcionId/historia', authorizeRole('SUPER_ADMIN', 'MEDICO'), ctrl.patchHistoriaRenal);
// ── Accesos Vasculares ───────────────────────────────────────
...
router.post('/renal/inscripciones/:inscripcionId/accesos', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.postAcceso);
router.patch('/renal/accesos/:id', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.patchAcceso);
...
router.post('/renal/inscripciones/:inscripcionId/sesiones', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.postSesion);
...
router.patch('/renal/sesiones/:id', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.patchSesion);
...
router.post('/renal/inscripciones/:inscripcionId/laboratorios', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.postLaboratorio);
router.patch('/renal/laboratorios/:id', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.patchLaboratorio);
// ── Eventos Adversos ─────────────────────────────────────────
router.get('/renal/inscripciones/:inscripcionId/eventos', ctrl.getEventos);
router.post('/renal/inscripciones/:inscripcionId/eventos', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.postEvento);
// ── Evoluciones Multidisciplinarias ─────────────────────────
router.get('/renal/inscripciones/:inscripcionId/evoluciones', ctrl.getEvoluciones);
router.post('/renal/inscripciones/:inscripcionId/evoluciones', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.postEvolucion);
// ── Tamizajes ─────────────────────────────────────────────────
router.get('/renal/inscripciones/:inscripcionId/tamizajes', ctrl.getTamizajes);
router.patch('/renal/tamizajes/:id', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.patchTamizaje);
...
router.post('/renal/turnos', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.postTurno);
...
router.delete('/renal/turnos/:inscripcionId', authorizeRole('SUPER_ADMIN', 'MEDICO'), ctrl.deleteTurno);
// ── P3: Serología ─────────────────────────────────────────────
...
router.post('/renal/inscripciones/:inscripcionId/serologia', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), ctrl.postSerologia);
