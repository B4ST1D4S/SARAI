...
const MODULOS: Modulo[] = [
  ...
  },
  {
    ...
    pasos: [
      ...
      { numero: 2, titulo: 'Secciones de la HC', descripcion: 'Las secciones son: (1) Datos de la consulta, (2) Motivo de consulta, (3) Enfermedad actual, (4) Revisión por sistemas, (5) Antecedentes, (6) Examen físico, (7) Signos vitales, (8) Paraclínicos, (9) Diagnóstico, (10) Plan, (11) Prescripción, (12) Notas.', tipo: 'normal' },
      { numero: 3, titulo: 'Usar dictado por voz (SARAI)', descripcion: 'Haz clic en el ícono de micrófono en cualquier campo de texto. Habla claramente y SARAI transcribe automáticamente usando Whisper. Requiere servicio Whisper activo.', tipo: 'tip' },
      { numero: 4, titulo: 'Agregar diagnósticos (APIO)', descripcion: 'En la sección de Diagnóstico, busca por código CIE-10 o nombre. Puedes agregar diagnóstico Principal, Relacionado, Complicación o Antecedente.', tipo: 'normal' },
      { numero: 5, titulo: 'Órdenes médicas', descripcion: 'Las 4 secciones de órdenes son: Procedimientos Quirúrgicos (CUPS), Medicamentos, Paraclínicos e Interconsultas. Cada una tiene búsqueda por código o nombre.', tipo: 'normal' },
      { numero: 6, titulo: 'Guardar e imprimir', descripcion: 'Haz clic en "Guardar" para guardar la HC. Luego desde Central de Impresión puedes generar el PDF oficial de la historia clínica.', tipo: 'success' },
      { numero: 7, titulo: 'Entregar historia clínica', descripcion: 'Usa el módulo de Entrega de HC para registrar la fecha y responsable de entrega al paciente.', tipo: 'normal' },
    ],
    tips: [
