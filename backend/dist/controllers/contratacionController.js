...
export async function listContratos(req, res) {
    try {
        const { estado, empresaId, busqueda } = req.query;
...
// ─── TARIFAS ────────────────────────────────────────────────────────────────
export async function upsertTarifa(req, res) {
    try {
        if (!req.user) {
            res.status(401).json({ error: 'No autenticado' });
            return;
...
export async function createExcepcion(req, res) {
    try {
        if (!req.user) {
            res.status(401).json({ error: 'No autenticado' });
            return;
...
// ─── CLONAR CONTRATO ────────────────────────────────────────────────────────
export async function clonarContrato(req, res) {
    try {
        if (!req.user) {
            res.status(401).json({ error: 'No autenticado' });
            return;
...
// ─── BENEFICIARIOS ──────────────────────────────────────────────────────────
export async function listBeneficiarios(req, res) {
    try {
...
export async function updateBeneficiario(req, res) {
    try {
        if (!req.user) {
            res.status(401).json({ error: 'No autenticado' });
            return;
