import { saveMapaCorporal, getMapaCorporalByProcedimiento, getMapaCorporalPorPaciente, updateMapaCorporal, deleteMapaCorporal, } from '../services/mapaCorporalService.js';
/**
...
export async function save(req, res) {
    try {
        ...
        const { pacienteId, procedimientoId, zonasMarcadas, edemaZonas, fibrosisZonas, dolorZonas, anotacionesClinics, } = req.body;
 ...
 */
export async function getByProcedimiento(req, res) {
    try {
        ...
        const mapaCorporal = await getMapaCorporalByProcedimiento(procedimientoId, pacienteId);
        if (!mapaCorporal) {
 ...
 */
export async function getByPaciente(req, res) {
    try {
