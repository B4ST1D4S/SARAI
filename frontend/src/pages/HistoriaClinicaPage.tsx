...
export default function HistoriaClinicaPage({
  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col bg-[#080a0f]">
        ...
        <div className="flex-1 overflow-y-auto p-5">
          ...
          <div className="space-y-2">
            {historias.map((h: any) => (
              ...
              <div className="flex-shrink-0 p-3 border-t border-white/[0.06] space-y-1.5">
                <button
                  type="submit"
                  disabled={loading || !form.pacienteId || !form.motivoConsulta}
            ...
            {/* ══ PANEL DERECHO: formulario continuo ══ */}
            <div id="hc-scroll-panel" className="flex-1 overflow-y-auto p-4 space-y-4">
      ...
      {/* ══ MODO LISTA (cuando no hay formulario) ══ */}
      {!showForm && (
        <div className="flex-1 overflow-y-auto p-5">
          <h2 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Historias Recientes</h2>
          {loading && !historias.length && (
