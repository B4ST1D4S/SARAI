...
import { create, getMedico, getPaciente, getById, update, confirmar, completar, cancelar, recordatorios, admision, } from '../controllers/citasController.js';
import { authenticateToken, authorizeRole } from '../middleware/auth.js';
const router = Router();
// Todos los endpoints de citas requieren autenticación
router.use(authenticateToken);
// POST /api/citas - Crear cita
router.post('/', authorizeRole('SUPER_ADMIN', 'MEDICO', 'RECEPCIONISTA', 'AUXILIAR'), create);
...
router.post('/:id/completar', authorizeRole('SUPER_ADMIN', 'MEDICO', 'AUXILIAR'), completar);
