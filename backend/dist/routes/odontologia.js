...
// Riesgos
getRiesgos, createRiesgo, updateRiesgo, deleteRiesgo, } from '../controllers/odontoParametrizacionController.js';
import { getCatalogos, buscarCargos, getOdontogramasByPaciente, getOdontogramaById, crearOdontograma, updateOdontograma, guardarPiezas, generarPlan, addPlanItem, updatePlanItem, deletePlanItem, cambiarEstadoTratamiento, addEvolucion, getTimeline, getResumen, } from '../controllers/odontogramaController.js';
const router = Router();
