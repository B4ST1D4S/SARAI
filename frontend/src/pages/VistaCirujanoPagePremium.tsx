...
import {
  ChevronLeft, ChevronRight, MessageSquare, Plus, Download,
  Clock, AlertCircle, CheckCircle, Eye, Volume2, Camera, Zap
} from 'lucide-react';
...
export default function VistaCirujanoPagePremium() {
