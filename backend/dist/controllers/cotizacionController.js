import { createCotizacion, getCotizacionById, getCotizacionesPaciente, getCotizacionesMedico, aceptarCotizacion, rechazarCotizacion, } from '../services/cotizacionService.js';
// Crear cotización
export async function create(req, res) {
    try {
        ...
        const { pacienteId, citaId, descripcionServicio, lineas, descuentoPorcentaje, notasAdicionales, vigenciaDias, } = req.body;
